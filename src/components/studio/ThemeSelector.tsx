...
const THEMES = Object.entries(THEME_CONFIG) as [DesignTheme, (typeof THEME_CONFIG)[DesignTheme]][];

export const ThemeSelector: React.FC<ThemeSelectorProps> = ({ theme, layout, onThemeChange, onLayoutChange }) => (
  <>
